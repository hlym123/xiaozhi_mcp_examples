...
if __name__ == "__main__":
    ...
    endpoint_url = "wss://api.xiaozhi.me/mcp/?token=eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEyMDMzMSwiYWdlbnRJZCI6MzMyODA5LCJlbmRwb2ludElkIjoiYWdlbnRfMzMyODA5IiwicHVycG9zZSI6Im1jcC1lbmRwb2ludCIsImlhdCI6MTc0Nzc4OTE1N30.I-JltohxDNAHIXrlFO35OM60yQvRKdmvdRvdzjhEqNgT3Q-rbwyxUeJOE88-JNB34GT7oJson72mT9b6Ew3nVg"# os.environ.get('MCP_ENDPOINT')
    if not endpoint_url:
